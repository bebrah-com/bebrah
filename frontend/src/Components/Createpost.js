  ...
  return (
    <div>
      <div className="w-[50%] mx-auto mt-2">
        <h1 className="text-4xl font-bold my-7">Create new post</h1>
        ...
        <div className="mt-3 w-[60%]">
          ...
          <p className="mt-1 text-sm">Name for your post.</p>
          <input
            type="text"
            placeholder="Name"
        ...
        <div className="mt-3 w-[60%]">
          ...
          <p className="mt-1 text-sm">Additional info for your post.</p>
          <textarea
            placeholder="Description"
            className="mt-3 border-[1px] border-[#676767] w-full px-3 py-4 h-40 placeholder:text-black"
          />
        </div>
        <button className="border-[1px] border-[#676767] bg-[#F5F5F5] my-6 w-32 py-3">Create</button>
      </div>
    </div>
  );
}
